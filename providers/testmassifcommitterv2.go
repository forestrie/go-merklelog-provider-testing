...
// StorageMassifCommitterV2FirstMassifTest covers creation of the first massif with generic storage
func StorageMassifCommitterV2FirstMassifTest[T storage.StorageMetadata](tc TestContextV2[T]) {
	var err error
	cfg := tc.GetTestCfg()
	t := tc.GetT()
	ctx := t.Context()
	...
	c, err := tc.NewMassifCommitterV2(massifs.StorageOptions{LogID: logID, MassifHeight: MassifHeight})
	require.NoError(t, err, "unexpected error creating massif committer")

	var mc *massifs.MassifContextV2[T]
	clock := time.Now()
...
// StorageMassifCommitterV2AddFirstTwoLeavesTest tests adding first two leaves with generic storage
func StorageMassifCommitterV2AddFirstTwoLeavesTest[T storage.StorageMetadata](tc TestContextV2[T]) {
	var err error
	cfg := tc.GetTestCfg()
	t := tc.GetT()
	ctx := t.Context()
...
// StorageMassifCommitterV2ExtendAndCommitFirstTest tests massif extension with generic storage
func StorageMassifCommitterV2ExtendAndCommitFirstTest[T storage.StorageMetadata](tc TestContextV2[T]) {
	var err error
	cfg := tc.GetTestCfg()
	t := tc.GetT()
	ctx := t.Context()
...
// StorageMassifCommitterV2CompleteFirstTest tests massif completion with generic storage
func StorageMassifCommitterV2CompleteFirstTest[T storage.StorageMetadata](tc TestContextV2[T]) {
	var err error
	cfg := tc.GetTestCfg()
	t := tc.GetT()
	ctx := t.Context()
...
// StorageMassifCommitterV2OverfillSafeTest tests overfill protection with generic storage
func StorageMassifCommitterV2OverfillSafeTest[T storage.StorageMetadata](tc TestContextV2[T]) {
	var err error
	cfg := tc.GetTestCfg()
	t := tc.GetT()
	ctx := t.Context()
...
// StorageMassifCommitterV2ThreeMassifsTest tests three massifs scenario with generic storage
func StorageMassifCommitterV2ThreeMassifsTest[T storage.StorageMetadata](tc TestContextV2[T]) {
	var err error
	cfg := tc.GetTestCfg()
	t := tc.GetT()
	ctx := t.Context()
